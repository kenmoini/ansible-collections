...
DOCUMENTATION = '''
---
module: site_to_site_tunnels_info
short_description: Returns the list of Site-to-Site Tunnels from Unifi Network
version_added: "1.0.0"
description:
    - Retrieves information about the list of Site-to-Site VPN Tunnels managed by this Unifi Network Application.
...
EXAMPLES = '''
# Get the List of Site-to-Site VPN Tunnels from the Unifi Network for a Site
- name: Get VPN Tunnels at a Site from Unifi Network
  ...
  register: r_site_to_site_tunnels_info
'''

RETURN = '''
site_to_site_tunnels_info:
    description: The data returned about the list of Site-to-Site VPN Tunnels at the Site managed by this Unifi Network Application
    type: object
    returned: always
'''
...
def run_module():
    ...
    targetURL = module.params['unifi_network_url'] + apiBaseURL + '/v1/sites/' + module.params['unifi_network_site_id'] + '/vpn/site-to-site-tunnels?' + query_params_str

    # Apply any filters to the request URL
    targetURL = filter_requests(module, targetURL, result)

    # Perform the API request to get the Site-to-Site Tunnels Info
    ...
    result['site_to_site_tunnels_info'] = response.json()
