...
---
module: network_info
short_description: Returns the details about a specific Network from Unifi Network
version_added: "1.0.0"
description:
    - Retrieves information about a specific Network managed by this Unifi Network Application.
...
def run_module():
    ...
    if response.status_code != 200:
        module.fail_json(msg='Failed to retrieve Network Info from Unifi Network', **result)
